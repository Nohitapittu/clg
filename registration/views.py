...
class RegistrationView(FormView):
    ...
    def register(self, form):
        ...
        """
        new_user = form.save()  # Assuming your form has a save method
        login(self.request, new_user)  # Automatically log in the user after registration
        return new_user
